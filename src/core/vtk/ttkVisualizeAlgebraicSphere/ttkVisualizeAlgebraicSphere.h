...
///
/// \ingroup vtk
/// \class ttkVisualizeAlgebraicSphere
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the ttk::VisualizeAlgebraicSphere module.
///
/// This VTK filter uses the ttk::VisualizeAlgebraicSphere module to compute an averaging of
...
///   - standalone/VisualizeAlgebraicSphere/main.cpp
///
/// See the related ParaView example state files for usage examples within a
/// VTK pipeline.
///
/// \sa ttk::VisualizeAlgebraicSphere
/// \sa ttkAlgorithm

#pragma once

// VTK Module
#include <ttkVisualizeAlgebraicSphereModule.h>
...
// TTK Base Includes
#include <VisualizeAlgebraicSphere.h>

class TTKVISUALIZEALGEBRAICSPHERE_EXPORT ttkVisualizeAlgebraicSphere
  : public ttkAlgorithm // we inherit from the generic ttkAlgorithm class
  ,
    protected ttk::VisualizeAlgebraicSphere // and we inherit from the base class
{
private:
  /**
...
public:
   ...
   */
  static ttkVisualizeAlgebraicSphere *New();
  vtkTypeMacro(ttkVisualizeAlgebraicSphere, ttkAlgorithm);
...
protected:
   ...
   */
  ttkVisualizeAlgebraicSphere();
  ~ttkVisualizeAlgebraicSphere() override = default;
