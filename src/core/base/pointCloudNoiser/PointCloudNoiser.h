...
///
/// \ingroup base
/// \class ttk::PointCloudNoiser
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// This module defines the %PointCloudNoiser class that computes for each vertex of a
...
namespace ttk {
  ...
  /**
   * The PointCloudNoiser class provides methods to compute for each vertex of a
   * triangulation the average scalar value of itself and its direct neighbors.
   */
  class PointCloudNoiser : virtual public Debug {
...
int addGaussianNoise(const double standard_deviation,
                                      const double mean,
                                      float* coordinates,
                                      const SimplexId n) const ;
int SmoothNormalsWithFit(double _scale, float* _coordinates, float* _normals, int _nbPoints, float* _smoothed_normals);
