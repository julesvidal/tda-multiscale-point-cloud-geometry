...
double ttk::BottleneckDistance::distanceFunction(const ttk::PersistencePair &a,
  ...
  const std::array<float, 3> coordsAbsDiffMax{
  ...
  const std::array<float, 3> coordsAbsDiffMin{
    std::abs(a.birth.coords[0] - b.birth.coords[0]),
    std::abs(a.birth.coords[1] - b.birth.coords[1]),
    std::abs(a.birth.coords[2] - b.birth.coords[2]),
  };

  const std::array<float, 3> coordsAbsDiff = isMax1 ? coordsAbsDiffMax : coordsAbsDiffMin;
