...
///
/// \ingroup base
/// \class ttk::ImageTo2DPointCloud
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// This module defines the %ImageTo2DPointCloud class that computes for each vertex of a
...
namespace ttk {
  ...
  /**
   * The ImageTo2DPointCloud class provides methods to compute for each vertex of a
   * triangulation the average scalar value of itself and its direct neighbors.
   */
  class ImageTo2DPointCloud : virtual public Debug {
