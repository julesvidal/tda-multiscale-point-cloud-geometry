...
std::vector<int> ttk::PDClustering<dataType>::execute(
  ...
  Timer tm;
  {
    ...
    // std::cout<<"\n\nDiag Min: "<<std::endl;
    //   for(int idiag=0; idiag<bidder_diagrams_min_.size(); idiag++){
    //     std::cout<<"  diag "<<idiag<<":
    //     "<<current_bidder_diagrams_min_[idiag].size()<<" /
    //     "<<bidder_diagrams_min_[idiag].size()<<std::endl;
    //     // for(int idiag2=0;
    //     idiag2<current_bidder_diagrams_min_[idiag].size(); idiag2++){
    //     //   std::cout<<"  pair "<<idiag2<<" :
    //     "<<current_bidder_diagrams_min_[idiag].get(idiag2).getPersistence()<<std::endl;
    //     // }
    //
    //   }
    // std::cout<<"\n\nDiag max: "<<std::endl;
    //   for(int idiag=0; idiag<bidder_diagrams_max_.size(); idiag++){
    //     std::cout<<"  diag "<<idiag<<":
    //     "<<current_bidder_diagrams_max_[idiag].size()<<" /
    //     "<<bidder_diagrams_max_[idiag].size()<<std::endl;
    //     // for(int idiag2=0;
    //     idiag2<current_bidder_diagrams_max_[idiag].size(); idiag2++){
    //     //   std::cout<<"  pair "<<idiag2<<" :
    //     "<<current_bidder_diagrams_max_[idiag].get(idiag2).getPersistence()<<std::endl;
    //     // }
    //   }
...
std::vector<dataType> ttk::PDClustering<dataType>::enrichCurrentBidderDiagrams(
  ...
  //     }
  // }
  std::vector<dataType> new_min_persistence
