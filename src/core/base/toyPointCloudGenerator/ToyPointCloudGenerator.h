...
///
/// \ingroup base
/// \class ttk::ToyPointCloudGenerator
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// This module defines the %ToyPointCloudGenerator class that computes for each vertex of a
/// triangulation the average scalar value of itself and its direct neighbors.
///
/// \b Related \b publication: \n
/// 'ToyPointCloudGenerator'
...
namespace ttk {
  ...
  /**
   * The ToyPointCloudGenerator class provides methods to compute for each vertex of a
   * triangulation the average scalar value of itself and its direct neighbors.
   */
  class ToyPointCloudGenerator : virtual public Debug {
