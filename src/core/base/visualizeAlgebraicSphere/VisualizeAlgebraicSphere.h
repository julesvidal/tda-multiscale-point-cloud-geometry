...
///
/// \ingroup base
/// \class ttk::VisualizeAlgebraicSphere
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// This module defines the %VisualizeAlgebraicSphere class that computes for each vertex of a
/// triangulation the average scalar value of itself and its direct neighbors.
///
/// \b Related \b publication: \n
/// 'VisualizeAlgebraicSphere'
...
namespace ttk {
  ...
  /**
   * The VisualizeAlgebraicSphere class provides methods to compute for each vertex of a
   * triangulation the average scalar value of itself and its direct neighbors.
   */
  class VisualizeAlgebraicSphere : virtual public Debug {
...
#pragma omp parallel for num_threads(this->threadNumber_)
  ...
  }; // VisualizeAlgebraicSphere class
